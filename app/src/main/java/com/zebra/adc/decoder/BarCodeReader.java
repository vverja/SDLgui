 ...
 *
 * <li>If necessary, modify the returned {@link BarCodeReader.Parameters} object
 * and call {@link #setParameters(BarCodeReader.Parameters)}.
 *
 * <li>Call {@link #setDecodeCallback(BarCodeReader.DecodeCallback)} to register
 * a bar code decode event handler.
 *
 * <li>If a view finder is desired, pass a fully initialized
 * {@link SurfaceHolder} to {@link #setPreviewDisplay(SurfaceHolder)}.
 *
 * <li>To begin a decode session, call {@link #startDecode()} or
 ...
 *
 * <li><b>Important:</b> Call {@link #release()} to release the BarCodeReader
...
public class BarCodeReader {
     ...
     * {@link BarCodeReader.Parameters#getPreviewSize()}. Bytes per pixel can be
     * computed from {@link android.graphics.ImageFormat#getBitsPerPixel(int)} /
     * 8, using the image format from
     * {@link BarCodeReader.Parameters#getPreviewFormat()}.
     *
     * <p>
     ...
     * @param forceDownload
     *            - whether to force download or not - recommended true
     * @param IgnoreSignature
     *            - whether to ignore signature - recommended false
     */
    public native final int FWUpdate(String FilePath, boolean forceDownload,
     ...
     *
     * <p>
     * {@link BarCodeReader.VideoCallback#onVideoFrame(format, width, height, byte[], BarCodeReader)}
     ...
     *
     * <p>
     * If {@link #setOneShotPreviewCallback(BarCodeReader.PreviewCallback)} or
     * {@link #setPreviewCallbackWithBuffer(BarCodeReader.PreviewCallback)} was
     * called,
     * {@link BarCodeReader.PreviewCallback#onPreviewFrame(byte[], BarCodeReader)}
     ...
     * {@link #setDecodeCallback(BarCodeReader.DecodeCallback)} was called,
     ...
     * if
     * {@link com.zebra.adc.decoder.BarCodeReader.Parameters#isSmoothZoomSupported}
     * returns true.
     *
     * @param value
     *            zoom value. The valid range is 0 to
     *            {@link com.zebra.adc.decoder.BarCodeReader.Parameters#getMaxZoom}
     *            .
     ...
     * session. For a regular decode session, it will return 1
     */
     ...
     * BCRDR_MSG_LAST_DEC_IMAGE is triggered
     */
    ...
    public static class PropertyNum {
        ...
        /**
         * Property number used to get the Zebra engine extended status (4
         * bytes) Returned data includes both instantaneous(byte 0) and latched
         * data(byte 3)
         */
    ...
    public static BarCodeReader open() {
        ...
        for (iIdx = 0; iIdx < iNumReaders; ++iIdx) {
            ...
            // if ( readerInfo.facing ==
            // BarCodeReader.ReaderInfo.BCRDR_FACING_BACK )
            {
     ...
     * Creates a new BarCodeReader object to access the first back-facing reader
     * on the device. If the device does not have a back-facing reader, this
     * returns null. Use this for Android version 4.3 and above
     * 
     * @see #open(int)
     */
     ...
     * installed on devices <em>without</em> auto-focus, you must declare that
     * your app uses the
     * {@code android.hardware.camera.autofocus} feature, in the
	 * <a href="{@docRoot} feature, in the <a href="{@docRoot} feature,
     * in the <a href="{@docRoot} feature, in the <a href="{@docRoot}
     * feature, in the <a href="{@docRoot} feature, in the <a href="{@docRoot}
     * feature, in the <a href="{@docRoot} feature, in the <a href="{@docRoot}
    ...
    public interface AutoFocusCallback {
         ...
         * called immediately with a fake value of <code>success</code> set to
         * <code>true</code>.
         *
         * @param success
     ...
     * {@link com.zebra.adc.decoder.BarCodeReader.Parameters#getFocusMode()} to
     ...
     * {@link com.zebra.adc.decoder.BarCodeReader.Parameters#FLASH_MODE_OFF},
    ...
    public interface PreviewCallback {
         ...
         *            with
         *            {@link com.zebra.adc.decoder.BarCodeReader.Parameters#getPreviewFormat()}
         *            . If
         *            {@link com.zebra.adc.decoder.BarCodeReader.Parameters#setPreviewFormat(int)}
     ...
     * callback or if
     * {@link #setOneShotPreviewCallback(BarCodeReader.PreviewCallback)} is
     * called.
     *
     * @param cb
    ...
    private class EventHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            Log.i(TAG, String.format("Event message: %X, arg1=%d, arg2=%d",
            ...
            switch (msg.what) {
                ...
                case BCRDR_MSG_DECODE_TIMEOUT:
                    if (mDecodeCallback != null) {
                        mDecodeCallback.onDecodeComplete(0, 0,
                                (byte[]) msg.obj, mReader);
                    }
                    return;
                ...
                case BCRDR_MSG_DECODE_CANCELED:
                    if (mDecodeCallback != null) {
                        mDecodeCallback.onDecodeComplete(0,
                                DECODE_STATUS_CANCELED, (byte[]) msg.obj,
                                mReader);
                    }
                    return;
                ...
                case BCRDR_MSG_DECODE_ERROR:
                    if (mDecodeCallback != null) {
                        mDecodeCallback.onDecodeComplete(0,
                                DECODE_STATUS_ERROR, (byte[]) msg.obj, mReader);
                    }
                    return;
                ...
                case BCRDR_MSG_PREVIEW_FRAME:
                    if (mPreviewCallback != null) {
                        ...
                        if (mOneShot) {
                            ...
                            // in case the app calls setOneShotPreviewCallback
                            // from
                ...
                case BCRDR_MSG_FOCUS:
                    if (mAutoFocusCallback != null) {
                        mAutoFocusCallback.onAutoFocus(msg.arg1 == 0 ? false
                                : true, mReader);
                    }
                    return;
                ...
                case BCRDR_MSG_ZOOM:
                    if (mZoomListener != null) {
                        mZoomListener.onZoomChange(msg.arg1, msg.arg2 != 0,
                                mReader);
                    }
                    return;
                ...
                case BCRDR_MSG_DEC_COUNT:
                    if (mDecodeCallback != null) {
                        mDecodeCallback.onDecodeComplete(msg.arg1,
    ...
    private static void postEventFromNative(Object reader_ref, int what,
        ...
        BarCodeReader c = (BarCodeReader) ((WeakReference<BarCodeReader>) reader_ref)
                .get();
     ...
     * {@link #setParameters(BarCodeReader.Parameters)} to take effect.
     *
     ...
     * {@link BarCodeReader#setParameters(BarCodeReader.Parameters)}. For
     * example, after {@link BarCodeReader.Parameters#setWhiteBalance} is
     * called, white balance is not actually changed until
     * {@link BarCodeReader#setParameters(BarCodeReader.Parameters)} is called
     ...
     * {@link BarCodeReader.Parameters#getSupportedColorEffects()} before
     * calling {@link BarCodeReader.Parameters#setColorEffect(String)}. If the
     * reader does not support color effects,
     * {@link BarCodeReader.Parameters#getSupportedColorEffects()} will return
     * null.
     */
    public class Parameters {
         ...
         * blur in images captured with {@link Camera#takePicture takePicture}.
         * </p>
         *
         * <p>
         ...
         * {@link android.graphics.ImageFormat#NV21}, which uses the NV21
         * encoding format.
         * </p>
         *
         * @param pixel_format
         *            the desired preview picture format, defined by one of the
         *            {@link android.graphics.ImageFormat} constants. (E.g.,
         ...
         *
         * @param pixel_format
         *            the desired picture format (<var>ImageFormat.NV21</var>,
         *            <var>ImageFormat.RGB_565</var>, or
         *            <var>ImageFormat.JPEG</var>)
         * @see android.graphics.ImageFormat
         */
